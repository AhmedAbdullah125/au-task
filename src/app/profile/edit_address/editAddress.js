...
export const editAddress = async (data, addressId, setLoading, lat, lng, router) => {
    ...
    const url = `${API_BASE_URL}/user/address/${addressId}`; // API endpoint
    try {
        ...
        if (response.status === 200 || response.status === 201) {
            ...
            toast(message, {
                style: { borderColor: "#28a745", boxShadow: '0px 0px 10px rgba(40, 167, 69, .5)', },
            });
